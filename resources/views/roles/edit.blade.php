            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-title d-flex justify-content-between m-3 mt-0">
                        <h5><strong>Update</strong> New Role</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('roles.update', $role->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="title" value="{{ old('name', $role->name) }}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter New Role">
                                    @error('name')
